...
const Notes = (props) => {
  ...
  const handleClick = (e) => {
    ...
    props.showAlert("Updated man !!! eeeyyuuu","warning") 
  }
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-footer">
              ...
              <button type="button" className="btn btn-primary" disabled={note.etitle<5 || note.edescription<5} onClick={handleClick}>Save changes</button>
            </div>
          </div>
        </div>
      </div>
